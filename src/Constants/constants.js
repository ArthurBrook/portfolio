...
const introduction = {
  text: [
    ...
    "My name is Arthur Brook and I am a full stack developer based in Ukraine. My passion for web development started in February 2022 when I began fron-end courses.",
